...
# log
parser.add_argument('--log_dir', default='./results/economicgrasp', help='Dump dir to save model checkpoint [default: log]')

# model setting
# parser.add_argument('--model', type=str, default='graspness', help='graspnessp')
parser.add_argument('--model', type=str, default='economicgrasp', help='graspnessp')
...
parser.add_argument('--checkpoint_path', default='results/economicgrasp/economicgrasp_epoch10.tar', 
...
parser.add_argument('--save_dir', default='results/economicgrasp/test_ep10_seen', 
                    help='Dir to save outputs')
parser.add_argument('--test_mode', default='seen', 
                    help='Mode of the testing (seen, similar, novel)')
...
# parser.add_argument('--inference', default=True, help='Whether to inference')
